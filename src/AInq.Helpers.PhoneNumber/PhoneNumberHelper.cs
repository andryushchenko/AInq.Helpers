...
public static class PhoneNumberHelper
{
    ...
    [PublicAPI]
    public static IReadOnlyCollection<string> PhoneRegions { get; set; } = [CultureInfo.CurrentCulture.Name.Split('-').Last().ToUpperInvariant()];
    ...
    extension(string source)
    {
        ...
        [PublicAPI]
        public ISet<string> GetPhones(IEnumerable<string> phoneRegions, bool trimExtension = false)
        ...
        [PublicAPI]
        public ISet<string> GetPhones(bool trimExtension = false, params string[] phoneRegions)
        ...
        [PublicAPI]
        public ISet<string> GetMobilePhones(IEnumerable<string> phoneRegions, bool strict = true)
